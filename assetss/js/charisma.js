$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','http://localhost/AndgateReMS/assets/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	//pie chart
	var data = [
	{ label: "Sandwiches",  data: 10},
	{ label: "Next Cup Special Sandwiches",  data: 15},
	{ label: "Fresh Salad Items",  data: 20},
	{ label: "Burgers & Roll Items",  data: 25},
	{ label: "Classic Hot Coffee",  data: 30},
	{ label: "Flavored Hot Coffee",  data: 30}
	];
